...
<div class="taskOne-container">
        <div class="titlediv">
            ...
            <span class="titlespan">整改审核-列表</span>
        </div>
        ...
        <div style="width: 1580px">
            ...
            <el-table border ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 1580px"
                ...
                <el-table-column prop="orgName" v-model="organiza" label="发起机构" width="440" align="center" >
                </el-table-column>
                <el-table-column prop="draftName" v-model="manuscript" label="任务名称" width="440" align="center">
                </el-table-column>
                <el-table-column prop="departName" v-model="depart" label="牵头部门" width="440" align="center">
                </el-table-column>
 ...
 data(){
    ...
    methods:{  // 任务流转
      ...
      // 样式相关调整
        ...
        // 初始化表格数据
        initTable() {
            axios.post("http://101.201.29.183:3500/RectAudit/getDraftLists?pageNum=1&pageSize=10",{
                orgId: "",draftName: "",leadDepartId:"",departId:"opr861202",missionId:"_4"
            }).then(res=>{
                console.log(res);
        ...
        handleCurrentChange(val) {
            ...
            console.log('触发分页', val);
             axios.post(`http://101.201.29.183:3500/RectAudit/getDraftLists?pageNum=${val}&pageSize=10`,{
               orgId: this.formInline.institution||'',
               draftName: this.formInline.taskName||'',
               leadDepartId:this.formInline.part||'',
               departId: "opr861202",missionId:"_4"
            }).then(res=>{
              this.tableData = res.data.data
              this.total = res.data.total
            })
        ...
        getDetail(scope) {
            ...
            this.$router.push({name:'taskTwo',query: {
